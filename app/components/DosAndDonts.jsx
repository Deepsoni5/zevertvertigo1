  ...
  return (
    ...
    >
      <div className="flex space-x-4 mb-8">
        ...
        <sup className="font-bold text-lg hidden md:flex">1-9,36-40</sup>
      </div>
        ...
        {activeTab === "dos" && (
          <>
            ...
            <div className="bg-white shadow-md rounded-lg p-4 flex items-center space-x-4 w-full">
              ...
              />
              <p className="break-words text-sm md:text-xl">
                Over the counter medicines to be used with caution e.g. aspirin,
                antacids, anti-inflammatory and caffeine containing drugs.
              </p>
            </div>
            <div className="bg-white shadow-md rounded-lg p-4 flex items-center space-x-4 w-full">
              <img
